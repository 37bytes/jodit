...
## 3.20.4 (патч)
- Вставка стилизованной таблицы, добавление новой таблицы
- Добавление возможности скрывать табы для color picker'а
- Параметр для открытия ссылок в новой вкладке при скрытой форме
- Добавление опциональности для кэширования способа вставки из буфера
- Добавление обратных событий на превышение лимита и количества введенных символов/слов
- Исправление удаления данных через delete с позицией курсора в конце
